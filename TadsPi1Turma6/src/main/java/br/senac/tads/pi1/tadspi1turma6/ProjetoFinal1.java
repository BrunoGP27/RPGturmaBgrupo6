...
public class ProjetoFinal1 {
   ...
   static int Entrada() {
    ...
    static boolean PuzzelIgreja() {
        ...
        System.out.println("\nO monstro começa a se aproximar, para onde você vai?");
        System.out.println("");
        ...
        switch (n1) {
            case 1:
                System.out.println("Você vê uma série de janelas quebradas e um alçapão mais ao fundo.");
                System.out.println("\n[1]janelas \n[2]alçapão \n[3]fundo da igreja");
                n1 = Entrada();
                while (n1 != 3) {
                    if (n1 == 1) {
    ...
    public static int retornoMenu() {//funcao para receber o menu
        ...
        } while (c1 < 1 || c1 > 4);
        {
            ...
            if (c1 == 2) {
                ...
                System.out.println("Digite 1 para voltar ao Menu principal, ou 2 para sair.");
                a = input.nextInt();
                if (a == 1) {
    ...
    public static int Boneco1() {
        ...
        System.out.println("Logo após entrar no local, percebo que está tudo muito escuro, então decido acender meu isqueiro,"
                ...
                + "\n'VOCÊ VAI SANGRAR HA HA HA!!!, CADA GOTA DE SANGUE  HA HA HA!!!"
                + "\nAssustado e sem entender muito bem o que se passa,você entra na primeira sala que encontro, "
        ...
        switch (a) {
            case 1:
                System.out.println("Percebo que o boneco está evitando a área próximo ao forno, talvez se eu conseguir atrair ele até o fogão,"
    ...
    public static int boneco2() {
        ...
        System.out.println("\n[1]Tentar Distrai-lo, jogando um objeto para direção oposta. \n[2]Atacar na primeira oportunidade.");
        ...
        switch (a) {
            case 1:
                ...
                System.out.println("Me aproximo das cinzas do boneco, e encontro o que parece ser uma parte de um velho mapa.");
                break;
            case 2:
    ...
    public static int inimigoBoneco2() {
        ...
        switch (a) {
            ...
            case 2:
                ...
                System.out.println("me proximo das cinzas do boneco umas estranha folha de papel esta no meio delas marece ser um mapa");
                break;
            default:
                System.out.println("Opção invalida");
                c = inimigoBoneco2();
    ...
    public static String palhaco1() {
        ...
        System.out.println("Logo após entrar no local, Percebo que os gritos de socorro pararam, e então vou seguindo por uma passagem que encontrei na sepultura,\n"
                ...
                + "No mesmo instante o palhaço mudou seu semblante e disse “ENTÃO VOCE VAI MORRER...”, no mesmo instante percebi que não tinha saída a não ser jogar o maldito jogo.");
        System.out.println("Então ele explica que gosta de charadas, e que se eu não acertasse a sua charada, ele iria me matar");
        System.out.println("==========================================================================================================================================================");
        System.out.println("“AÍ VAI A CHARADA”");
    ...
    static void cenarioIgreja() {
        ...
        System.out.println("Você anda até a construção abandonada e percebe que é uma espécie de igreja. \n"
                + "Ao me aproximar da porta percebo que ela está trancada, ouço um estralo de um galho atras de min  \n"
    ...
    static boolean Oguia() {
        ...
        if (n3 == 2) {
            System.out.println("os espíritos se revoltam, não satisfeitos com suas atitudes eles te condenam a morte");
            System.out.println("e você ao se desanuviar, não percebe que sua energia e força vital está sendo drenada");
            System.out.println("ao ver seu reflexo em uma pequena poça de agua, consegue se enxergar envelhecendo anos em questão de segundos");
            System.out.println("vendo o pouco cabelo branco que resta em sua cabeça, você se entrega a morte... se deixando levar... olhando para luz");
            i = GameOver();
            return false; 
        } 
        if(n3 == 1){
    ...
    static void Espiritos(int n1) {
        switch (n1) {
            ...
            case 4:
                ...
                System.out.println("caso queira saber quem realmente é ruim nessa sala é a velha ela mentiu para todos e ainda foi traída no final");
                break;
    ...
    public static char mapafinal(){
        System.out.println("==========================================================================================================================================================");
        System.out.println("\nPor um breve momento sinto uma forte tensão em meu corpo, e em um piscar de olhos estou novamente em meu carro... Estou sendo observado por criaturas estranhas e a única coisa que consigo pensar é que eles são os responsáveis pela experiência que acabará de viver. \n" +
"\n" +
